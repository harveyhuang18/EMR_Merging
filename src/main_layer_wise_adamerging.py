...
task_vectors = [TaskVector(pretrained_checkpoint, '/remote-home/yepeng2/ADAMerging/checkpoints/'+model+'/'+dataset_name+'/finetuned.pt') for dataset_name in exam_datasets]
